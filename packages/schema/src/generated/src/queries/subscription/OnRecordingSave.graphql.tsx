/* b1b7de49a4259798092afed474874adc8a5a7258
...
export type OnRecordingSaveSubscriptionVariables = Exact<{
  [key: string]: never;
}>;

export type OnRecordingSaveSubscription = { __typename?: 'Subscription' } & {
  ...
  definitions: [
    {
      ...
      name: { kind: 'Name', value: 'OnRecordingSave' },
      variableDefinitions: [],
      directives: [],
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'recordingSaved' },
            arguments: [],
            directives: [],
            selectionSet: {
              kind: 'SelectionSet',
