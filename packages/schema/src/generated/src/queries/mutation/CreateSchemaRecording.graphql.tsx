/* ece123563c4f98136145a7ea19fc58fb13a6d343
...
export type CreateSchemaRecordingMutationVariables = Exact<{
  input: CreateSchemaRecordingInput;
}>;


export type CreateSchemaRecordingMutation = (
  { __typename?: 'Mutation' }
  & { createSchemaRecording: (
    { __typename?: 'CreateSchemaRecordingResponse' }
    & Pick<CreateSchemaRecordingResponse, 'schemaHash'>
  ) }
);


export const CreateSchemaRecordingDocument: DocumentNode<CreateSchemaRecordingMutation, CreateSchemaRecordingMutationVariables> = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateSchemaRecording"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateSchemaRecordingInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createSchemaRecording"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"schemaHash"}}]}}]}}]};
