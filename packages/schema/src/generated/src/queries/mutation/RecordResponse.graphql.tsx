/* 6f5ad3e0fc361fbf739db753953000043c1417b6
...
export type RecordResponseMutation = { __typename?: 'Mutation' } & {
  recordResponse: { __typename?: 'RecordResponseResponse' } & {
    newRecording: { __typename?: 'Recording' } & Pick<
      Recording,
...
export const RecordResponseDocument: DocumentNode<
  RecordResponseMutation,
  RecordResponseMutationVariables
> = {
  kind: 'Document',
  definitions: [
    {
      ...
      operation: 'mutation',
      name: { kind: 'Name', value: 'RecordResponse' },
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'RecordResponseInput' },
            },
          },
          directives: [],
        },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'newRecording' },
                  arguments: [],
                  directives: [],
                  selectionSet: {
                    kind: 'SelectionSet',
...
export type CreateRecordingResponseResolvers<
  ContextType = any,
...
export type RecordResponseResponseResolvers<
  ContextType = any,
