...
export type CreateTemporarySchemaRecordingMutationVariables = Exact<{
  input: CreateTemporarySchemaRecordingInput;
}>;


export type CreateTemporarySchemaRecordingMutation = (
  { __typename?: 'Mutation' }
...
export const CreateTemporarySchemaRecordingDocument: DocumentNode<CreateTemporarySchemaRecordingMutation, CreateTemporarySchemaRecordingMutationVariables> = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateTemporarySchemaRecording"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateTemporarySchemaRecordingInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createTemporarySchemaRecording"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"schemaHash"}}]}}]}}]};
