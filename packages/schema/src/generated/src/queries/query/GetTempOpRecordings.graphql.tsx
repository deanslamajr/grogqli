/* 53dca2fab655e4baa2d3a69cc9e6e65f94bc8d43
...
export type GetTempOpRecordingsQueryVariables = Exact<{
  input: TemporaryOperationRecordingsInput;
}>;


export type GetTempOpRecordingsQuery = (
  { __typename?: 'Query' }
...
export const GetTempOpRecordingsDocument: DocumentNode<GetTempOpRecordingsQuery, GetTempOpRecordingsQueryVariables> = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetTempOpRecordings"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"TemporaryOperationRecordingsInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"temporaryOperationRecordings"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"TempOpRecordingFragment"}}]}}]}},...TempOpRecordingFragmentFragmentDoc.definitions]};
