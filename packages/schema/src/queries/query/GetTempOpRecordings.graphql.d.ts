/* cd21e2f412d90f591781f7d3add6e04a9567b38a
...
export declare type GetTempOpRecordingsQueryVariables = Exact<{
    input: TemporaryOperationRecordingsInput;
}>;
export declare type GetTempOpRecordingsQuery = ({
    __typename?: 'Query';
} & {
    temporaryOperationRecordings: Maybe<Array<({
        __typename?: 'TemporaryOperationRecording';
...
export declare const GetTempOpRecordingsDocument: DocumentNode<GetTempOpRecordingsQuery, GetTempOpRecordingsQueryVariables>;
