/* 4e1534f046b905f089b672ef22f272df5b91e5ec
...
export declare type GetSchemasQueryVariables = Exact<{
    [key: string]: never;
}>;
export declare type GetSchemasQuery = ({
    __typename?: 'Query';
} & {
    schemas: Maybe<Array<({
        __typename?: 'SchemaRecording';
    } & Pick<SchemaRecording, 'id' | 'hash' | 'name' | 'schemaUrls' | 'introspectionQuery'>)>>;
});
