/* 2cb225e1cad4d8ec52e6ce901b235bf2e05e2cdc
...
export declare type CreateWorkflowRecordingPlanInput = {
    operations: Array<OperationRecordingsInput>;
};
export declare type CreateWorkflowRecordingPlanResponse = {
    __typename?: 'CreateWorkflowRecordingPlanResponse';
    newPlan: WorkflowRecordingPlan;
};
export declare type WorkflowRecordingPlan = {
...
export declare type OperationRecordingPlan = {
...
export declare type MutationCreateWorkflowRecordingPlanArgs = {
...
export declare type CreateWorkflowRecordingPlanMutationVariables = Exact<{
    input: CreateWorkflowRecordingPlanInput;
}>;
export declare type CreateWorkflowRecordingPlanMutation = ({
    __typename?: 'Mutation';
} & {
    createWorkflowRecordingPlan: ({
        ...
        newPlan: ({
            ...
            operationRecordingPlans: Array<({
                __typename?: 'OperationRecordingPlan';
            } & Pick<OperationRecordingPlan, 'id' | 'opName' | 'sdl' | 'temporarySchemaRecordingHash' | 'rootTypeRecordingIds'> & {
                typeRecordingPlans: Array<({
                    __typename?: 'TypeRecordingPlan';
                } & Pick<TypeRecordingPlan, 'typeName' | 'typeRecordingId'> & {
                    value: ({
                        __typename?: 'TypeRecordingValue';
                    } & Pick<TypeRecordingValue, 'type' | 'reference' | 'value'>);
                })>;
            })>;
            schemaMatchResults: Array<({
                __typename?: 'SchemaMatchResult';
            } & Pick<SchemaMatchResult, 'temporarySchemaRecordingHash'> & {
                schemaMatch: ({
                    __typename?: 'SchemaMatch';
                } & Pick<SchemaMatch, 'schemaId' | 'schemaHash'>);
            })>;
            schemas: Array<({
                __typename?: 'SchemaRecording';
            } & Pick<SchemaRecording, 'id' | 'hash' | 'name'>)>;
        });
    });
});
export declare const CreateWorkflowRecordingPlanDocument: DocumentNode<CreateWorkflowRecordingPlanMutation, CreateWorkflowRecordingPlanMutationVariables>;
...
export declare type CreateWorkflowRecordingPlanResponseResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateWorkflowRecordingPlanResponse'] = ResolversParentTypes['CreateWorkflowRecordingPlanResponse']> = ResolversObject<{
    newPlan: Resolver<ResolversTypes['WorkflowRecordingPlan'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
export declare type WorkflowRecordingPlanResolvers<ContextType = any, ParentType extends ResolversParentTypes['WorkflowRecordingPlan'] = ResolversParentTypes['WorkflowRecordingPlan']> = ResolversObject<{
...
export declare type OperationRecordingPlanResolvers<ContextType = any, ParentType extends ResolversParentTypes['OperationRecordingPlan'] = ResolversParentTypes['OperationRecordingPlan']> = ResolversObject<{
...
export declare type TypeRecordingValueResolvers<ContextType = any, ParentType extends ResolversParentTypes['TypeRecordingValue'] = ResolversParentTypes['TypeRecordingValue']> = ResolversObject<{
...
export declare type TypeRecordingPlanResolvers<ContextType = any, ParentType extends ResolversParentTypes['TypeRecordingPlan'] = ResolversParentTypes['TypeRecordingPlan']> = ResolversObject<{
...
export declare type SchemaMatchResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['SchemaMatchResult'] = ResolversParentTypes['SchemaMatchResult']> = ResolversObject<{
    temporarySchemaRecordingHash: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    schemaMatch: Resolver<ResolversTypes['SchemaMatch'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
export declare type SchemaMatchResolvers<ContextType = any, ParentType extends ResolversParentTypes['SchemaMatch'] = ResolversParentTypes['SchemaMatch']> = ResolversObject<{
