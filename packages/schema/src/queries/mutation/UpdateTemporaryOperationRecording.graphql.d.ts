/* 9e67d03a73e4e32b204b619849f555405588a151
...
export declare type UpdateTemporaryOperationRecordingMutationVariables = Exact<{
    input: UpdateTemporaryOperationRecordingInput;
}>;
export declare type UpdateTemporaryOperationRecordingMutation = ({
    __typename?: 'Mutation';
} & {
...
export declare const UpdateTemporaryOperationRecordingDocument: DocumentNode<UpdateTemporaryOperationRecordingMutation, UpdateTemporaryOperationRecordingMutationVariables>;
