...
export declare type RecordResponseMutationVariables = Exact<{
    input: RecordResponseInput;
}>;
export declare type RecordResponseMutation = ({
    __typename?: 'Mutation';
} & {
    recordResponse: ({
        __typename?: 'RecordResponseResponse';
...
export declare const RecordResponseDocument: DocumentNode<RecordResponseMutation, RecordResponseMutationVariables>;
