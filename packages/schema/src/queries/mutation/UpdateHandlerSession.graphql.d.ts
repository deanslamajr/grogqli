/* 0173bbba76e0c5d8f15361fa09b044e50f62275b
...
export declare type UpdateHandlerSessionMutationVariables = Exact<{
    input: UpdateHandlerSessionInput;
}>;
export declare type UpdateHandlerSessionMutation = ({
    __typename?: 'Mutation';
} & {
...
export declare type HandlerSessionFragmentFragment = ({
    __typename?: 'Handler';
} & Pick<Handler, 'id' | 'name' | 'currentState' | 'workflowId'>);
export declare const HandlerSessionFragmentFragmentDoc: DocumentNode<HandlerSessionFragmentFragment, unknown>;
export declare const UpdateHandlerSessionDocument: DocumentNode<UpdateHandlerSessionMutation, UpdateHandlerSessionMutationVariables>;
