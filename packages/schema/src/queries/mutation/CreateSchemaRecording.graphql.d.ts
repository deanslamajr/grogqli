...
export declare type CreateSchemaRecordingMutationVariables = Exact<{
    input: CreateSchemaRecordingInput;
}>;
export declare type CreateSchemaRecordingMutation = ({
    __typename?: 'Mutation';
} & {
...
export declare const CreateSchemaRecordingDocument: DocumentNode<CreateSchemaRecordingMutation, CreateSchemaRecordingMutationVariables>;
