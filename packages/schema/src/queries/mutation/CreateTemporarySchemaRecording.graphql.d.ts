/* 5b3a1412e4b9d35efaaca96feb668fc52038e25b
...
export declare type CreateTemporarySchemaRecordingMutationVariables = Exact<{
    input: CreateTemporarySchemaRecordingInput;
}>;
export declare type CreateTemporarySchemaRecordingMutation = ({
    __typename?: 'Mutation';
} & {
    createTemporarySchemaRecording: ({
        __typename?: 'CreateTemporarySchemaRecordingResponse';
    } & Pick<CreateTemporarySchemaRecordingResponse, 'schemaHash'>);
});
export declare const CreateTemporarySchemaRecordingDocument: DocumentNode<CreateTemporarySchemaRecordingMutation, CreateTemporarySchemaRecordingMutationVariables>;
