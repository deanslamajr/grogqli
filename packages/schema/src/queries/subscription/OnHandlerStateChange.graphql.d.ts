...
export declare type OnHandlerStateChangeSubscriptionVariables = Exact<{
    input: HandlerStateChangeSubscriptionInput;
}>;
export declare type OnHandlerStateChangeSubscription = ({
    __typename?: 'Subscription';
} & {
...
export declare const OnHandlerStateChangeDocument: DocumentNode<OnHandlerStateChangeSubscription, OnHandlerStateChangeSubscriptionVariables>;
